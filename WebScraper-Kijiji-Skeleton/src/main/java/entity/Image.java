...
@NamedQueries({
    ...
    @NamedQuery(name = "Image.findContaining", query = "SELECT i FROM Image i WHERE i.name like CONCAT('%', :search, '%') or i.url like CONCAT('%', :search, '%') or i.path like CONCAT('%', :search, '%')")})
